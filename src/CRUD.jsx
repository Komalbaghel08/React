  ...
  return (
    <>
      ...
      <form onSubmit={post} style={{ marginBottom: "20px" }}>
        ...
        <input name="checkin" placeholder="CheckIN" value={form.checkin} onChange={handleChange} /> <br /><br /> 
        <input name="checkout" placeholder="CheckOut" value={form.checkout} onChange={handleChange} /> <br /><br /> 
        <input name="price" placeholder="Price" value={form.price} onChange={handleChange} /> <br /><br /> 
        <input name="people" placeholder="People" value={form.people} onChange={handleChange} /> <br /><br /> 
        <input name="total" placeholder="Total" value={form.total} onChange={handleChange} /> <br /><br /> 
